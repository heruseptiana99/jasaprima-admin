<h4 class="mb-3">Data Wajib Pajak (WP)</h4>

<div class="srolling-horizontal mb-3">
    <button class="btn btn-primary" style="margin-right: 15px;" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fa-solid fa-plus" style="margin-right: 15px;"></i>Tambah WP</button>
...
<div class="capsul">
    ...
    <tbody>
        <tr>
            ...
            <td>Desc Item 3</td>
            <td>
                <a href="<?= base_url(); ?>wp/ubah" class="btn btn-success"><i class="fa-solid fa-eye"></i></a>
                <a href="<?= base_url(); ?>wp/ubah" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Tambah Wajib Pajak (WP)</h5>
