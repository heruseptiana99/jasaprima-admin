...
<div class="srolling-horizontal mb-3">
    <a href="<?= base_url(); ?>transaksi/tambah" class="btn btn-primary" style="margin-right: 15px;"><i class="fa-solid fa-plus" style="margin-right: 15px;"></i>Tambah Transaksi Baru</a>
